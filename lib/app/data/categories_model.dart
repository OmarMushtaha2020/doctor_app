class CategoriesModel {
  ...
  CategoriesModel(this.nameCategories, this.detailsCategories,
      this.imageCategories, this.like, this.tokenOfDoctor,
      {this.id, this.idOfPatients, this.idOfMyCategories});

...
class PageSelectionDoctorOrPatientView
    extends GetView<PageSelectionDoctorOrPatientController> {
  LayoutPatientsAppController layoutPatientsAppController =
      LayoutPatientsAppController();

  @override
  Widget build(BuildContext context) {
    print("the initLang is${layoutPatientsAppController.initLang.toString()}");
      ...
      builder: (controller) {
        return Scaffold(
          ...
          bottomSheet: Container(
            ...
            height: 200,
            child: Align(
              alignment: layoutPatientsAppController.initLang == Locale("ar")
  ...
  bulidContainerOfDoctor(void Function() onTap, bool value) => CustomAnimation(
      Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
              color: value ? Colors.blue : Colors.white, width: value ? 2 : 0),
        ...
        child: GestureDetector(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              CustomText(value ? Colors.blue : Colors.white, 18.sp,
                  FontWeight.w600, "Doctor".tr),
              CustomSizeBox(
                0.h,
                width: 10.w,
              ),
  ...
  bulidContainerOfPatients(void Function() onTap, bool value) =>
      CustomAnimation(
          Container(
            height: 60.h,
            width: double.infinity,
            ...
            child: GestureDetector(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  CustomText(value ? Colors.white : Colors.blue, 18.sp,
                      FontWeight.w600, "Patients".tr),
                  CustomSizeBox(
                    0.h,
                    width: 10.w,
                  ),

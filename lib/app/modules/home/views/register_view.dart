  ...
  Widget build(BuildContext context) {
    return GetBuilder<RegisterController>(
      ...
      builder: (controller){
        ...
        children: [
        CustomAnimation(
        CustomText(Colors.black, 30, FontWeight.w600,
        "Let's create a doctor account".tr),
        0),
        CustomSizeBox(
        50,
        ),
        CustomAnimation(
        CustomTextForm(
        name, "Enter your name".tr, TextInputType.name,
    validator: (name) {
    if (name!.isEmpty) {
    ...
    CustomAnimation(
    CustomTextForm(
    phone, "Enter your phoneNumber".tr, TextInputType.phone,
    ...
    CustomAnimation(
    CustomTextForm(password, "Enter your password".tr,
    ...
    CustomAnimation(
    controller.registerValue==false?
    CustomButtom(() {
    ...
    "Continue".tr, 15):Center(child: const CircularProgressIndicator()),
    2500),
    CustomSizeBox(20),
    CustomAnimation(
    Row(

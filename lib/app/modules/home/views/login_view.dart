                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomAnimation(
                        controller.loginValue==false?  CustomButtom(() {if (formKey.currentState!.validate()) {
                            controller.login(email.text, password.text);}}, Colors.blue, 50, double.infinity, 10, Colors.white,
                            "Log In".tr, 15):Center(child: const CircularProgressIndicator()),
                        2000,),
                      CustomSizeBox(20),
                      CustomAnimation(
                          Row(

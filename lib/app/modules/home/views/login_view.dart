            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  CustomAnimation(
                     Row(
                      ...
                      children: [
                        ...
                        CustomText(Colors.blue, 30, FontWeight.w600, "Doctors".tr),
                  ...
                  CustomAnimation(
                     CustomTextForm(
                        email, "Enter email address".tr,TextInputType.emailAddress,
                         validator: (email){
                          if(email!.isEmpty){
                  ...
                  CustomAnimation( CustomTextForm(password, "Master password".tr,TextInputType.visiblePassword,
                      validator: (password){
                    if(password!.isEmpty){

...
// });
          ...
          body: controller.article.length == 0
              ? Column(
              ...
              : ListView.separated(
                  itemBuilder: (controllers, index) => Padding(
                        ...
                        child: Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              loginController.moveBetweenPages(
                                  ...
                                  arguments: {
                                    ...
                                    "id": argument['id'],
                                    "idOfArticle":
                                        controller.article[index].idOfArticle,
                                    "nameCategories":
                                        argument['nameCategories'],
                            ...
                            child: Row(
                              children: [
                                Padding(
                                  padding: layoutPatientsAppController.initLang
                                          .toString()
                                          .contains("ar")
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image: NetworkImage(
                                              "${controller.article[index].image}"),
                                          fit: BoxFit.cover),
                                    ),
                                  ),
                                ),
                                ...
                                CustomText(Colors.black, 20, FontWeight.w600,
                                    "${controller.article[index].name}"),
                                const Spacer(),
                                controller.article[index].tokonofDoctor ==
                                        tokenOfDoctors
                                    ? Padding(
                                            ...
                                            loginController.moveBetweenPages(
                                                ...
                                                arguments: {
                                                  "image": controller
                                                      .article[index].image,
                                                  "id": argument['id'],
                                                  "idOfArticle": controller
                                                      .article[index]
                                                      .idOfArticle,
                                                  "nameCategories": argument[
                                                      'nameCategories'],
                                                  "name": controller
                                                      .article[index].name,
                                                  "details": controller
                  ...
                  separatorBuilder: (controller, index) => CustomSizeBox(
                        20,
                      ),
